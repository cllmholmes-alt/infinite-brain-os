...
3. No deployment without gates.
4. No autonomy without permissions.
5. No learning without rollback.
6. No completion without traceability.
   Corollaries: no fake completion; no fabricated evidence/tests; no hidden assumptions;
   no secret leakage; no client-settable authority; no raw unrestricted tool execution;
   no external/customer/public action without approval; no protected-branch merge without
